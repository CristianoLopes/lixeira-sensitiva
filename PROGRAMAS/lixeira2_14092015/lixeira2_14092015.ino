...
int num_pins =;
int timer = 50;
int led []= {38,40,42,44,46,48};
int ledBranco = 4, SPir = 22 ; 
const int trigPin = 24; // DEFINE O PINO DE GATILHO DO SENSOR ULTRASSONICO COMO PORTA 8 
const int echoPin = 23; // DEFINE O PINO RECEPTOR DO SENSOR DE DISTANCIA COMO PORTA 7

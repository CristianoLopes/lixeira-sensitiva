...
int timer = 50;
int led []= {45,47,49};
int ledBranco = 4, SPir = 31 ; 
const int trigPin = 46; // DEFINE O PINO DE GATILHO DO SENSOR ULTRASSONICO COMO PORTA 8 
const int echoPin = 44; // DEFINE O PINO RECEPTOR DO SENSOR DE DISTANCIA COMO PORTA 7
...
myservo.attach(24);  //  CONFIGURA O OBJETO SERVO COMO PORTA 2 
